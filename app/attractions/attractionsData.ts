export const attractionsData = [
  {
    ...
    activities: ['Boat rides', 'Photography', 'Nature walks', 'Bird watching'],
    facilities: ['Boat services', 'Rest areas', 'Food stalls', 'Parking'],
    tips: ['Carry camera for stunning photos', 'Wear comfortable shoes', 'Best visited in morning hours', 'Book boat rides in advance']
  },
  {
    id: 2,
    name: 'Perantalapalli',
    ...
    activities: ['Village walks', 'Cultural interactions', 'Traditional craft viewing', 'River side relaxation'],
    facilities: ['Local guides', 'Traditional food', 'Craft shops', 'Rest areas'],
    tips: ['Respect local customs', 'Try traditional food', 'Interact with locals', 'Carry cash for purchases']
  },
  {
    id: 3,
    ...
    bestTime: 'Year round',
    activities: ['Prayer and meditation', 'Architecture viewing', 'Religious ceremonies', 'Spiritual discussions'],
    facilities: ['Prayer halls', 'Prasadam distribution', 'Parking', 'Rest areas'],
    tips: ['Dress modestly', 'Remove footwear before entering', 'Maintain silence', 'Respect religious practices']
  },
  {
    id: 4,
    ...
    bestTime: 'Year round',
    activities: ['Temple darshan', 'Religious ceremonies', 'Festival participation', 'Spiritual learning'],
    facilities: ['Temple complex', 'Accommodation', 'Food courts', 'Parking', 'Shopping'],
    tips: ['Visit during festivals for special experience', 'Book accommodation in advance', 'Carry valid ID', 'Follow temple timings']
  },
  {
    id: 5,
    ...
    bestTime: 'October to March',
    activities: ['Camping', 'Campfire sessions', 'Stargazing', 'Nature walks', 'Photography'],
    facilities: ['Tents', 'Campfire area', 'Basic amenities', 'Food arrangements', 'Safety measures'],
    tips: ['Carry warm clothes', 'Book in advance', 'Bring flashlight', 'Follow safety guidelines']
  },
  {
    id: 6,
    name: 'Maredumalli',
    ...
    activities: ['Waterfall visits', 'Trekking', 'Wildlife photography', 'Nature exploration'],
    facilities: ['Trekking guides', 'Rest areas', 'Food stalls', 'First aid'],
    tips: ['Wear trekking shoes', 'Carry water bottles', 'Follow guide instructions', 'Respect wildlife']
  },
  {
    id: 7,
    name: 'Parnasala',
    ...
    bestTime: 'October to March',
    activities: ['Historical exploration', 'Cultural learning', 'Photography', 'Meditation'],
    facilities: ['Information center', 'Guided tours', 'Rest areas', 'Parking'],
    tips: ['Learn about the mythology', 'Carry camera', 'Respect the sacred site', 'Visit with guide for better understanding']
  },
  {
    id: 8,
    name: 'Gudisa',
    ...
    activities: ['Mountain climbing', 'Panoramic viewing', 'Photography', 'Adventure sports'],
    facilities: ['Viewpoints', 'Rest areas', 'Food stalls', 'Parking'],
    tips: ['Carry warm clothes', 'Wear comfortable shoes', 'Start early for best views', 'Check weather conditions']
  }
]